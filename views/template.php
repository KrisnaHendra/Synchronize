...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <script data-ad-client="ca-pub-3941697810598132" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
</head>
	...
	<section id="intro">
		<div class="intro-container wow fadeIn">
			...
			<img class="pb-0 event-img" src="<?= base_url(); ?>assets/img/logo/OH NAIS LOGO 2.png" alt="" title=""
				height="390px">
				<?php $link = "https://www.youtube.com/watch?v=R0rg_cWMjFw";
				
				?>
			<a href="<?= $link; ?>" class="venobox play-btn mb-4" data-vbtype="video" data-autoplay="true"></a>
